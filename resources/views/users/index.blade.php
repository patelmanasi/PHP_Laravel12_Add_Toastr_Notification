...
<head>
    ...
    <style>
        ...
        .search-form input { flex: 1; padding: 6px; border-radius: 4px; border: 1px solid #ccc; }
        #toastr { position: fixed; top: 20px; right: 20px; z-index: 9999; min-width: 200px; }
        #toastr div { margin-bottom: 10px; padding: 10px; color: #fff; border-radius: 4px; animation: fadein 0.5s, fadeout 0.5s 2.5s; }
